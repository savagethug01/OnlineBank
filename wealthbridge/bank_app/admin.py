...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ['user', 'account_number', 'bic_code', 'imf_code', 'tax_code', 'linking_code', 'balance', 'card_number', 'cvv', 'expiry_date', 'card_application_fee_code']  # Include balance in the admin list
